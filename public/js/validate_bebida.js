...
function iniciar() {
  document.getElementById('crearBebida').addEventListener('submit', validarFormulario);
  document.getElementById('editarBebida').addEventListener('submit', validarFormularioEdit);
}
